	...
	<tr>
		<td width=400px" valign="top">
			<form method="POST" id="ldap_form" action="<?=View::url($this->getCollectionObject()->getCollectionPath());?>">
				<h1><span><?php echo t("Basic Authentication Configuration")?></span></h1>
			
				<div class="ccm-dashboard-inner">
				
						<table width="100%" border="0" cellspacing="5" cellpadding="0">
							<tr>
								<td><?php echo $form->label('LDAP_HOST', 'LDAP Host Name/Address:')?></td>
							...
							<tr>
								<td><?php echo $form->label('LDAP_DOMAIN_NAME', 'Default Domain Name:')?></td>
		...
		<?php //removed $host from if and replaced it by a "false" to prevent from showing following HTML  ?>
		<?php if(false) { ?>
